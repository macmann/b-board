...
export async function GET(
  ...
  return withRequestContext(request, async () => {
    ...
    try {
      ...
      logDebug("Build list query completed", { projectId, count: builds.length });
      ...
      logError("Failed to list builds", { projectId, error });
...
export async function POST(
  ...
  return withRequestContext(request, async () => {
    ...
    try {
      ...
      logError("Failed to create build", { projectId, error });
